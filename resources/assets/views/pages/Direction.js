                    ...
                    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne">
                      <div class="card-body">
                          <p>
                              ...
                              <br><br>
                              Ако пък се озовете в центъра на Долна Малина и сте дошли до селото с кола, кметството трябва да
                              остане от дясната ви страна, а вие продължавате в права линия - към село Априлово. Прекосявате моста
                              и след него, веднага свивате вляво по полския път (не по асфалта). След още 2 километра (5 минути с кола), отново само
                              в права линия, ще стигнете до локацията. Разстоянието може да се извърви и пеш за около 20 минутки.
                          </p>
                      </div>
                    </div>
                    </div>
