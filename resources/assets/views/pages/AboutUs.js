            ...
            <div class="doma-wrapper">
              <div class="row mt-sm-5 mb-3 animated-row">
                ...
                <div class="col-lg-4 col-sm-6 text-left mt-4 mt-sm-0 pl-sm-5 pl-xs-0 d-flex align-items-flex-start about-us-info">
                    ...
                    <p>
                        Йонко е бивш кмет на село Долна Малина и основател на Malina Open Fest. Той е актьор, режисьор и продуцент и всичките му личности свирят на пиано. Обича сцената и камерата и те го обичат. Завръща се от Лондон, за да превърне Долна Малина в културно средище.
                    </p>
                </div>
              </div>
                ...
                <div class="row mt-sm-5 mb-3 pt-4 animated-row">
                  ...
                  <div class="col-lg-4 col-sm-6 text-left mt-4 mt-sm-0 pl-sm-5 pl-xs-0 d-flex align-items-flex-start about-us-info">
                      ...
                      <p>
                          Дени е филолог, режисьор, занимавала се е с импро театър и танци. Когато се вдъхнови - пише в унисон с постмодернистичната душа, която носи. Върл фен на книгите, високо  оценява хубавото вино, обича природата, духовните практики и джембетата. Дени е една от трите основателки на Кадъръ Медия и има сериозен опит като продуцент в телевизия.
                      </p>
                  </div>
                </div>
                <div class="row mt-sm-5 mb-3 pt-4 animated-row">
                ...
                <div class="row mt-sm-5 pt-4 animated-row">
                  ...
                  <div class="col-lg-4 col-sm-6 text-left mt-4 mt-sm-0 pl-sm-5 pl-xs-0 d-flex align-items-flex-start about-us-info">
                      ...
                      <p>
                        Хриси е графичен дизайнер и илюстратор, вдъхновяващ се от мечтите, музиката и света около себе си. Винаги работи по няколко проекта едновременно, обича предизвикателствата и често може да бъде забелязана по концерти. Ако търсите виновника за визията на фестивала - тя е вашият човек.
                      </p>
                  </div>
                </div>
        </div>
